...
\title{ASR for Under-Resourced Languages from Probabilistic
  Transcription} \author{Mark Hasegawa-Johnson$^1$, Adrian KC Lee$^2$,
  Ed Lalor$^3$, Preethi Jyothi$^1$, Daniel McCloy$^2$, Majid
  Mirbagheri$^2$, Giovanni di Liberto$^3$, Amit Das$^1$, Brad
  Ekin$^2$, Chunxi Liu$^4$, Vimal Manohar$^4$, Hao Tang$^5$, Nancy
  Chen$^6$, Paul Hager$^7$, Tyler Kekona$^2$, and Rose Sloan$^8$}
...
\input{s5_methods_phonotactics.tex}
